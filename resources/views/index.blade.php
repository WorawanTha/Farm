...
<html>
  <head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="vendor/bootstrap/<?php echo url('/'); ?>/css/bootstrap.min.css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="vendor/font-awesome/<?php echo url('/'); ?>/css/font-awesome.min.css">
    <!-- Google fonts - Roboto -->
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<?php echo url('/'); ?>/<?php echo url('/'); ?>/css/style.default.css" id="theme-stylesheet">
  ...
  <body>
    ...
    *** COPYRIGHT ***
    ...
    <script src="vendor/bootstrap/<?php echo url('/'); ?>/js/bootstrap.bundle.min.js"></script>
